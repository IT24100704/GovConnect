import {
  Officer, Team, Complaint, SLAPolicy, SLATracker, RiskScore, RiskHeatmapEntry,
  OfficerPerformance, TeamPerformance, Escalation, EscalationHistory,
  ComplianceCheckItem, ComplianceCheckRecord, OverrideRecord,
  PublicServiceImpact, ImpactMetrics, BudgetAllocation, ProgramOutcome,
  BudgetVsOutcomeAnalysis, Alert, AnomalyAlert, DecisionLog,
  TransparencyExport, KPISnapshot, ExecutiveDashboardMetrics,
  EscalationReason, AlertTrigger
} from '@/lib/types';
